...
mixin _$CropHistory {
 ...
 String get id; String get fieldId; int get cellIndex; String get plantId; int get year; bool get diseaseLogged; String? get diseaseNote;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,fieldId,cellIndex,plantId,year,diseaseLogged,diseaseNote);
...
@useResult
$Res call({
 String id, String fieldId, int cellIndex, String plantId, int year, bool diseaseLogged, String? diseaseNote
});
...
/// Create a copy of CropHistory
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? fieldId = null,Object? cellIndex = null,Object? plantId = null,Object? year = null,Object? diseaseLogged = null,Object? diseaseNote = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String fieldId,  int cellIndex,  String plantId,  int year,  bool diseaseLogged,  String? diseaseNote)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CropHistory() when $default != null:
return $default(_that.id,_that.fieldId,_that.cellIndex,_that.plantId,_that.year,_that.diseaseLogged,_that.diseaseNote);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String fieldId,  int cellIndex,  String plantId,  int year,  bool diseaseLogged,  String? diseaseNote)  $default,) {final _that = this;
switch (_that) {
case _CropHistory():
return $default(_that.id,_that.fieldId,_that.cellIndex,_that.plantId,_that.year,_that.diseaseLogged,_that.diseaseNote);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String fieldId,  int cellIndex,  String plantId,  int year,  bool diseaseLogged,  String? diseaseNote)?  $default,) {final _that = this;
switch (_that) {
case _CropHistory() when $default != null:
return $default(_that.id,_that.fieldId,_that.cellIndex,_that.plantId,_that.year,_that.diseaseLogged,_that.diseaseNote);case _:
  return null;
...
class _CropHistory implements CropHistory {
  const _CropHistory({required this.id, required this.fieldId, required this.cellIndex, required this.plantId, required this.year, this.diseaseLogged = false, this.diseaseNote});
...
/// Create a copy of CropHistory
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? fieldId = null,Object? cellIndex = null,Object? plantId = null,Object? year = null,Object? diseaseLogged = null,Object? diseaseNote = freezed,}) {
